...
-- getInput ∷ (HGLFW i t m) ⇒ WM i m (Input t)
-- getInput = WidgetM $ (wcInput <$> ask)

-- getLBinds ∷ MonadTrace m ⇒ WM i m LBinds
-- getLBinds = WidgetM $ (wcLBinds <$> ask)

-- runWidgetMLBinds ∷ (HGLFW i t m) ⇒ LBinds → WM i m a → WM i m a
