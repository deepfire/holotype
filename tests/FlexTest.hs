...
test_grow1 =
  let r = _mkItem 60 240 ()
          [ _mkItem 60 30 () [] & placement.grow .~ 0
          , _mkItem 60  0 () [] & placement.grow .~ 1
          , _mkItem 60  0 () [] & placement.grow .~ 2
          ] & layout
...
test_grow2 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 20 () [] & placement.grow .~ 1
          , _mkItem 100 20 () [] & placement.grow .~ 0
          , _mkItem 100 20 () []
          ] & layout
...
test_grow3 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 50 () [] & placement.grow .~ 2
          , _mkItem 100 50 () [] & placement.grow .~ 3
          ] & layout
...
test_grow5 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 25 () [] & placement.grow .~ 1
          ] & layout
...
test_grow6 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 45 () [] & placement.grow .~ 1
          , _mkItem 100 45 () [] & placement.grow .~ 1
          ] & layout
...
test_wrap2 =
  let r = _mkItem 100 300 ()
          ...
          , _mkItem 50 150 () []
            ...
            & placement.align'content .~ AlignStart
            & layout
...
test_wrap5 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 50 () []
            ...
            & placement.justify'content .~ AlignEnd
            & placement.align'content   .~ AlignStart
            & layout
  in testGroup "wrap5: "
...
test_wrap6 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 50 () []
            ...
            & placement.justify'content .~ AlignCenter
            & placement.align'content   .~ AlignStart
            & layout
  in testGroup "wrap6: "
...
test_wrap7 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 50 () []
            ...
            & placement.justify'content .~ AlignSpaceAround
            & placement.align'content   .~ AlignStart
            & layout
  in testGroup "wrap7: "
...
test_wrap8 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 50 () []
            ...
            & placement.justify'content .~ AlignSpaceBetween
            & placement.align'content   .~ AlignStart
            & layout
  in testGroup "wrap8: "
     [ testCase "child 0" $ r^.child 0.area @?= Area (po   0   0) (di  50  50)
...
test_wrap9 =
  let r = _mkItem 120 120 ()
          [ _mkItem 50 50 () []
          , _mkItem 50 50 () [] & placement.grow .~ 1
          , _mkItem 50 50 () [] & placement.grow .~ 1
          , _mkItem 50 50 () []
          ] & placement.wrap            .~ Wrap
            & placement.align'content   .~ AlignStart
...
test_wrap10 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 60 () []
            ...
            & placement.align'items     .~ AlignStart
            & layout
  in testGroup "wrap10: "
...
test_wrap11 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 60 () []
            ...
            & placement.align'items     .~ AlignCenter
            & layout
  in testGroup "wrap11: "
...
test_wrap12 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 50 60 () []
            ...
            & placement.align'items     .~ AlignEnd
            & layout
  in testGroup "wrap12: "
...
test_wrap13 =
  let r = _mkItem 120 120 ()
          [ _mkItem 50 40 () [] & placement.align'self .~ AlignEnd
          , _mkItem 70 30 () []
          , _mkItem 60 40 () [] & placement.align'self .~ AlignCenter
          , _mkItem 40 50 () [] & placement.align'self .~ AlignStart
          , _mkItem 50 60 () []
          , _mkItem 10 10 () [] & placement.align'self .~ AlignEnd
          ] & placement.wrap .~ Wrap
            & layout
...
test_wrap16 =
  let r = _mkItem 120 120 ()
          ...
          , _mkItem 20 50 () []
          , _mkItem 20 50 () []
          ] & placement.direction       .~ DirColumn
            & placement.wrap            .~ Wrap
            & placement.align'content   .~ AlignStretch
            & layout
  in testGroup "wrap16: "
...
test_basis1 =
  let r = _mkItem 100 100 ()
          [ _mkItem' (Just 100) Nothing () [] & placement.basis .~ 60
          , _mkItem        100  40      () []
          ] & layout
  in testGroup "basis1: "
     [ testCase "child 0" $ r^.child 0.area @?= Area (po   0   0) (di 100  60)
...
test_basis2 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 40 () [] & placement.basis .~ 60
          , _mkItem 100 40 () []
          ] & layout
...
test_basis5 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 40 () [] & placement.basis .~ 0
          , _mkItem 100 40 () []
          ] & layout
...
test_order1 =
  let r = _mkItem 200 200 ()
          [ _mkItem 50 50 () [] & placement.order .~ Just 1
          , _mkItem 50 50 () [] & placement.order .~ Just 3
          , _mkItem 50 50 () [] & placement.order .~ Just 2
          ] & layout
  in testGroup "order1: "
     [ testCase "child 0" $ r^.child 0.area @?= Area (po   0   0) (di  50  50)
     , expectFail $
...
test_order2 =
  let r = _mkItem 200 200 ()
          ...
          , _mkItem 50 50 () [] & placement.order .~ Just 3
          , _mkItem 50 50 () [] & placement.order .~ Just 1
          ] & placement.direction .~ DirColumnReverse
            & layout
  in testGroup "order2: "
     [ expectFail $
...
test_margin1 =
  let r = _mkItem 100 100 ()
          [ _mkItem  25 25 () []
          , _mkItem  25 25 () [] & placement.margin .~ LRTB 15 15 10 10
          , _mkItem  25 25 () []
          ] & placement.align'items     .~ AlignStart
            & placement.justify'content .~ AlignStart
            & layout
...
test_margin5 =
  let r = _mkItem 100 100 ()
          [ _mkItem  10 10 () []
          , _mkItem  10 10 () [] & placement.margin .~ LRTB 15 10 0 0
          , _mkItem  10 10 () []
          ] & placement.align'items     .~ AlignCenter
            & placement.justify'content .~ AlignStart
            & layout
...
test_margin6 =
  let r = _mkItem 100 100 ()
          [ _mkItem  10 10 () []
          , _mkItem   0 10 () [] & placement.margin     .~ LRTB 15 10 0 0
                                 & placement.align'self .~ AlignStretch
          , _mkItem  10 10 () []
          ] & layout
...
test_margin8 =
  let r = _mkItem 100 100 ()
          [ _mkItem' Nothing (Just 10) () [] & placement.margin .~ LRTB 10  0 0 0
          , _mkItem' Nothing (Just 10) () [] & placement.margin .~ LRTB  0 10 0 0
          , _mkItem' Nothing (Just 10) () [] & placement.margin .~ LRTB 10 20 0 0
          ] & placement.direction .~ DirColumn
            & layout
...
test_margin9 =
  let r = _mkItem 100 100 ()
          [ _mkItem' (Just 10) Nothing () [] & placement.margin .~ LRTB 0 0 10  0
          , _mkItem' (Just 10) Nothing () [] & placement.margin .~ LRTB 0 0  0 10
          , _mkItem' (Just 10) Nothing () [] & placement.margin .~ LRTB 0 0 10 20
          ] & placement.direction .~ DirRow
            & layout
...
test_shrink1 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 100 () [] & placement.shrink .~ 2
          , _mkItem 100 100 () [] & placement.shrink .~ 3
          ] & layout
...
test_shrink2 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 100 () []
          , _mkItem 100 100 () [] & placement.shrink .~ 4
          ] & layout
...
test_shrink3 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 40 () [] & placement.shrink .~ 2
          , _mkItem 100 40 () [] & placement.shrink .~ 3
          ] & layout
...
test_shrink5 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 550 () [] & placement.shrink .~ 1
          ] & layout
...
test_shrink6 =
  let r = _mkItem 100 100 ()
          [ _mkItem 100 75 () [] & placement.shrink .~ 1
          , _mkItem 100 75 () [] & placement.shrink .~ 1
          ] & layout
...
test_padding1 =
  let r = _mkItem 100 100 ()
          [ _mkItem  25 25 () []
            ...
            & placement.justify'content .~ AlignStart
            & placement.align'items     .~ AlignStart
            & placement.padding         .~ LRTB 10 15 15 10
            & layout
...
test_padding5 =
  let r = _mkItem 100 100 ()
          [ _mkItem  0 25 () [] & placement.align'self .~ AlignStretch
          ] & placement.direction       .~ DirColumn
            & placement.justify'content .~ AlignStart
            & placement.align'items     .~ AlignStart
            & placement.padding         .~ LRTB 10 15 15 10
...
test_position1 =
  let r = _mkItem 100 100 ()
          [ _mkItem  10 10 () [] & placement.positioning .~ Absolute
          ] & layout
...
test_position4 =
  let r = _mkItem 100 100 ()
          [ _mkItem' Nothing (Just 20) () [] & placement.positioning .~ Absolute
                                             & absolute          .~ LRTB (Just 10) (Just 10) Nothing   Nothing
          , _mkItem' (Just 20) Nothing () [] & placement.positioning .~ Absolute
                                             & absolute          .~ LRTB  Nothing   Nothing (Just 10) (Just 10)
          ] & layout
...
test_position6 =
  let r = _mkItem 200 200 ()
          [ _mkItem  50 50 () []
          , _mkItem  50 50 () [] & placement.positioning .~ Absolute
...
test_position8 =
  let r = _mkItem 100 100 ()
          [ _mkItem' Nothing Nothing ()
            [ _mkItem  60 60 ()
              [ _mkItem  40 40 () [] & placement.positioning .~ Absolute
                                     & absolute          .~ LRTB (Just 10)  Nothing   Nothing (Just 10)
              ] & placement.positioning .~ Absolute
                & absolute          .~ LRTB  Nothing  (Just 10) (Just 10) Nothing
            ] & placement.positioning .~ Absolute
...
test_direction3 =
  let r = _mkItem 200 200 ()
          ...
          , _mkItem 50 50 () []
          , _mkItem 50 50 () []
          ] & placement.direction .~ DirRowReverse
            & layout
...
test_align_self1 =
  let r = _mkItem 100 100 ()
          [ _mkItem  50  25 () [] & placement.align'self .~ AlignStart
          , _mkItem  50  25 () [] & placement.align'self .~ AlignStart
          , _mkItem  50  25 () [] & placement.align'self .~ AlignStart
          ] & layout
...
test_align_self2 =
  let r = _mkItem 100 100 ()
          [ _mkItem  50  25 () [] & placement.align'self .~ AlignEnd
          , _mkItem  50  25 () [] & placement.align'self .~ AlignEnd
          , _mkItem  50  25 () [] & placement.align'self .~ AlignEnd
          ] & layout
...
test_align_self3 =
  let r = _mkItem 100 100 ()
          [ _mkItem  50  25 () [] & placement.align'self .~ AlignCenter
          , _mkItem  50  25 () [] & placement.align'self .~ AlignCenter
          , _mkItem  50  25 () [] & placement.align'self .~ AlignCenter
          ] & layout
...
test_align_self4 =
  let r = _mkItem 100 100 ()
          [ _mkItem' Nothing (Just 25) () [] & placement.align'self .~ AlignStretch
          , _mkItem        0       25  () [] & placement.align'self .~ AlignStretch
          , _mkItem' Nothing (Just 25) () [] & placement.align'self .~ AlignStretch
          ] & layout
...
test_align_self5 =
  let r = _mkItem 100 100 ()
          [ _mkItem  50  25 () [] & placement.align'self .~ AlignStretch
          , _mkItem  50  50 () [] & placement.align'self .~ AlignStretch
          , _mkItem  50  25 () [] & placement.align'self .~ AlignStretch
          ] & layout
...
test_align_items4 =
  let r = _mkItem 100 100 ()
          ...
          ] & placement.align'items .~ AlignStretch
            & layout
...
test_align_items5 =
  let r = _mkItem 100 100 ()
          [ _mkItem 50 25 () []
          , _mkItem 50 25 () [] & placement.align'self .~ AlignStart
          , _mkItem 50 25 () [] & placement.align'self .~ AlignAuto
          , _mkItem 50 25 () [] & placement.align'self .~ AlignEnd
          ] & placement.align'items .~ AlignCenter
            & layout
...
test_align_content2 =
  let r = _mkItem 200 120 ()
          ...
          , _mkItem  40  50      () []
            ...
            & placement.align'content .~ AlignCenter
            & layout
...
test_align_content3 =
  let r = _mkItem 200 120 ()
          ...
          , _mkItem  40  50      () []
            ...
            & placement.align'content .~ AlignEnd
            & layout
...
test_align_content4 =
  let r = _mkItem 200 120 ()
          ...
          , _mkItem  40  50      () []
            ...
            & placement.align'content .~ AlignSpaceBetween
            & layout
...
test_align_content5 =
  let r = _mkItem 200 120 ()
          ...
          , _mkItem  40  50      () []
            ...
            & placement.align'content .~ AlignSpaceAround
            & layout
...
test_align_content6 =
  let r = _mkItem 250 120 ()
          ...
          , _mkItem  40  50      () []
            ...
            & placement.align'content .~ AlignSpaceEvenly
            & layout
...
test_justify_content8 =
  let r = _mkItem 100 300 ()
          [ _mkItem 50 105 () []
          , _mkItem 50 105 () []
          ] & placement.justify'content .~ AlignSpaceEvenly
            & layout
  ...
  let modes = [AlignStart, AlignCenter, AlignEnd, AlignSpaceBetween, AlignSpaceAround, AlignSpaceEvenly]
      r mode
        = _mkItem 100 100 ()
          [ _mkItem 50 50 () []
          , _mkItem 50 50 () []
          ] & placement.justify'content .~ mode
            & layout
...
test_justify_content18 =
  let modes = [AlignStart, AlignCenter, AlignEnd, AlignSpaceBetween, AlignSpaceAround, AlignSpaceEvenly]
      r mode
        = _mkItem 100 100 ()
          [ _mkItem 50 20 () []
          , _mkItem 50 20 () [] & placement.grow .~ 1
          , _mkItem 50 20 () []
          ] & placement.justify'content .~ mode
            & layout
