...
***** Possibilities
      ...
      | Leaf  | Modifier  | FromTop | Style       | Hardness | ToTop | Shrinkable | Notes                                     |
      |-------+-----------+---------+-------------+----------+-------+------------+-------------------------------------------|
      | Text  | One-line  | ()      | font, break | Hard     | Abs   | no         |                                           |
      |       |           | ()      | font, break | Soft     | Rel   | ellipsis   |                                           |
      ...
      |       | Scalable  | AbsCstr | ()          | Soft     | Rel   | yes        | scaling                                   |
      | ???   |           |         |             |          |       |            | any other leaf types?                     |

      | Inter | Modifier | FromTop | Style     | ToBot   | FromBot | Hardness Honoring | ToTop |   | Notes |
      |-------+----------+---------+-----------+---------+---------+-------------------+-------+---+-------|
      | Box   |          | AbsCstr | ()        | AbsCstr | AbsReq  | Rebalancing       |       |   |       |
      | Wrap  |          | AbsCstr | thickness | AbsCstr | AbsReq  | ????????????????? |       |   |       |
