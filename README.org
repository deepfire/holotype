...
* Goals
*** For the DE
    1. Map the entire resident context available in a convenient way
...
*** Text size computation

    | Text | Designer width | Meaningful | Solution                         |
    |------+----------------+------------+----------------------------------|
    | -    | -              | -          | error?                           |
    | -    | +              | +          | fontQueryHeight + designer width |
    | +    | +/-            | +          | fontQuerySize                    |
...
* Storage backends
  - should support rich semantics
  - but in case we need stupid & reliable ACID data:
