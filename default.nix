...
# ghc.callPackage
# (
#{ stdenv, mkDerivation, base, base-unicode-symbols, containers, diagrams, hscolour, linear, netwire, optparse-generic, pkgconfig, reflection, sdl2, vector }:
 { stdenv, mkDerivation, base, base-unicode-symbols, containers,           hscolour, linear, netwire, optparse-generic, pkgconfig, reflection, sdl2, vector }:
mkDerivation {
  pname        = "mood";
  version      = "0.0.1";
  src          = ./.;
  isLibrary    = false;
  isExecutable = true;
# buildDepends = [ base base-unicode-symbols containers diagrams hscolour linear netwire optparse-generic pkgconfig reflection sdl2 vector ];
  buildDepends = [ base base-unicode-symbols containers          hscolour linear netwire optparse-generic                 pkgconfig reflection sdl2 vector ];
